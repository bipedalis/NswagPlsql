...
{
    public class SwaggerToPlSqlClientGeneratorViewModel : ViewModelBase
    {
        private string _clientCode;
        private OpenApiToPlSqlClientCommand _command = new OpenApiToPlSqlClientCommand();

        /// <summary>Gets the settings.</summary>
        public OpenApiToPlSqlClientCommand Command
        {
            get { return _command; }
            set
            {
