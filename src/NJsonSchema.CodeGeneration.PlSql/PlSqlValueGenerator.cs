...
namespace NJsonSchema.CodeGeneration.PlSql
{
    ...
    public class PlSqlValueGenerator : ValueGeneratorBase
    {
        ...
        /// <summary>Initializes a new instance of the <see cref="PlSqlValueGenerator" /> class.</summary>
        /// <param name="settings">The settings.</param>
        public PlSqlValueGenerator(PlSqlGeneratorSettings settings)
            : base(settings)
        {
            _settings = settings;
        }
