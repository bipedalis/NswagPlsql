...
{
    /// <summary>The PlSql class template model.</summary>
    public class ClassTemplateModel : ClassTemplateModelBase
    {
        ...
        public ClassTemplateModel(string typeName, PlSqlGeneratorSettings settings,
            PlSqlTypeResolver resolver, JsonSchema schema, object rootObject)
        ...
        public string BaseClassName => HasInheritance ? _resolver.Resolve(_schema.InheritedTypeSchema, false, string.Empty, false) : null;
