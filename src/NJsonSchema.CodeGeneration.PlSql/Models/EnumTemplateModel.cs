...
{
    // TODO: Add base class for PlSql.EnumTemplateModel and TypeScript.EnumTemplateModel

    /// <summary>The PlSql enum template model.</summary>
    public class EnumTemplateModel : TemplateModelBase
    {
        ...
        public EnumTemplateModel(string typeName, JsonSchema schema, PlSqlGeneratorSettings settings)
        {
            _schema = schema;
            _settings = settings;
            Name = typeName;
