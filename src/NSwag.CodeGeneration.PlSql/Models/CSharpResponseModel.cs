//-----------------------------------------------------------------------
// <copyright file="PlSqlResponseModel.cs" company="NSwag">
...
{
    /// <summary>The PlSql response model.</summary>
    public class PlSqlResponseModel : ResponseModelBase
    {
        /// <summary>Initializes a new instance of the <see cref="PlSqlResponseModel"/> class.</summary>
        ...
        public PlSqlResponseModel(IOperationModel operationModel, OpenApiOperation operation, string statusCode, OpenApiResponse response,
