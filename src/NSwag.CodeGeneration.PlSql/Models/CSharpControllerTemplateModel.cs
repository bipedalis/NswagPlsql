//-----------------------------------------------------------------------
// <copyright file="PlSqlControllerTemplateModel.cs" company="NSwag">
...
{
    /// <summary>The PlSql controller template model.</summary>
    public class PlSqlControllerTemplateModel : PlSqlTemplateModelBase
    {
        private readonly PlSqlControllerGeneratorSettings _settings;
        private readonly OpenApiDocument _document;

        /// <summary>Initializes a new instance of the <see cref="PlSqlControllerTemplateModel" /> class.</summary>
        /// <param name="controllerName">Name of the controller.</param>
        /// <param name="operations">The operations.</param>
        /// <param name="document">The document.</param>
        /// <param name="settings">The settings.</param>
        public PlSqlControllerTemplateModel(
            string controllerName,
            IEnumerable<PlSqlOperationModel> operations,
            OpenApiDocument document,
            PlSqlControllerGeneratorSettings settings)
        ...
        public bool IsAspNetCore => _settings.ControllerTarget == PlSqlControllerTarget.AspNetCore;

        /// <summary>Gets or sets a value indicating whether the output should target ASP.NET MVC.</summary>
        public bool IsAspNet => _settings.ControllerTarget == PlSqlControllerTarget.AspNet;
        ...
        public IEnumerable<PlSqlOperationModel> Operations { get; set; }
        ...
        public bool GeneratePartialControllers => _settings.ControllerStyle == PlSqlControllerStyle.Partial;

        /// <summary>Gets a value indicating whether to generate abstract controllers.</summary>
        public bool GenerateAbstractControllers => _settings.ControllerStyle == PlSqlControllerStyle.Abstract;
