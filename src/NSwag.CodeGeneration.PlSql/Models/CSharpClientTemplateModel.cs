//-----------------------------------------------------------------------
// <copyright file="PlSqlClientTemplateModel.cs" company="NSwag">
...
{
    /// <summary>The PlSql client template model.</summary>
    public class PlSqlClientTemplateModel : PlSqlTemplateModelBase
    {
        private readonly OpenApiDocument _document;
        private readonly JsonSchema _exceptionSchema;
        private readonly PlSqlClientGeneratorSettings _settings;

        /// <summary>Initializes a new instance of the <see cref="PlSqlClientTemplateModel" /> class.</summary>
        ...
        public PlSqlClientTemplateModel(
            string controllerName,
            string controllerClassName,
            IEnumerable<PlSqlOperationModel> operations,
            JsonSchema exceptionSchema,
            OpenApiDocument document,
            PlSqlClientGeneratorSettings settings)
        ...
        public IEnumerable<PlSqlOperationModel> Operations { get; }

        /// <summary>Gets the operations of the interface.</summary>
        public IEnumerable<PlSqlOperationModel> InterfaceOperations => Operations.Where(o => o.IsInterfaceMethod);
        ...
        //        var parameterCode = PlSqlJsonSerializerGenerator.GenerateJsonSerializerParameterCode(
        //            _settings.PlSqlGeneratorSettings, RequiresJsonExceptionConverter ? new[] { "JsonExceptionConverter" } : null);
        ...
        private bool RequiresJsonExceptionConverter => _settings.PlSqlGeneratorSettings.ExcludedTypeNames?.Contains("JsonExceptionConverter") != true &&
