//-----------------------------------------------------------------------
// <copyright file="SwaggerToPlSqlClientGeneratorSettings.cs" company="NSwag">
...
{
    /// <summary>Settings for the <see cref="PlSqlClientGenerator"/>.</summary>
    public class PlSqlClientGeneratorSettings : PlSqlGeneratorBaseSettings
    {
        /// <summary>Initializes a new instance of the <see cref="PlSqlClientGeneratorSettings"/> class.</summary>
        public PlSqlClientGeneratorSettings()
        {
